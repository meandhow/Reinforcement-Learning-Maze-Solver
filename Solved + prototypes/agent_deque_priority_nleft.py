...
class DQN:
    ...
    def __init__(self):
        ...
        self.optimiser_target = torch.optim.Adam(self.target_network.parameters(), lr=0.01)
    ...
    def _calculate_loss_bellman_minibatch_with_target(self, minibatch, gamma=0.95):
...
class Agent:
    ...
    def set_next_state_and_distance(self, next_state, distance_to_goal):
        ...
        if not self.training :
            ...
            if buffer_size >= 50:
                minibatch = self.buffer.half_priority_mini_batch(int(buffer_size / 20)) #+ int(self.num_steps_taken/100)
